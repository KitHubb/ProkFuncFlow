...
workflow {
 ...
 if (!params.module_definitions || !params.module_definitions_version) error '--module_definitions and --module_definitions_version are required'
 ...
 definitions=Channel.fromPath(params.module_definitions,checkIfExists:true)
 ...
 SUMMARIZE_C10(reps_manifest,clusters,PANGENOME_FUNCTION.out.modules,VALIDATE_C09.out.evidence,PANGENOME_FUNCTION.out.evidence,PANGENOME_FUNCTION.out.mapping,clade_map)
}
